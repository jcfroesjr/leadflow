...
- [ ] 13-02-PLAN.md — Wave 2 LEAVE handler: webhook REMOVE marca saiu_em + LEAD_SAIU_GRUPO + FSM LEFT_GROUP + lead_in_group source='left_group' + D-1/notif DM redirect (LEAVE-01/02/03)
...
| 13. LEAVE handler + FSM audit monotonico | 1/4 | In Progress|  |
